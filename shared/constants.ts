...
export const DEFAULT_COMPLAINTS = [
  {
    ...
    complainantNameAr: "الوفد الدبلوماسي البريطاني (Lord Harrington)",
    complainantNameEn: "UK Diplomatic Delegation (Lord Harrington)",
    complainantRole: "VIP Guest",
    complainantRoleAr: "ضيف VIP",
    complainantRoleEn: "VIP Guest",
    severity: "HIGH" as const,
    category: "TRANSPORT" as const,
    description: "تأخر وصول موكب الحراسة المرافق من صالة المطار الملكية لمدة 12 دقيقة بسبب تحويل مسار أمني مؤقت.",
    descriptionAr: "تأخر وصول موكب الحراسة المرافق من صالة المطار الملكية لمدة 12 دقيقة بسبب تحويل مسار أمني مؤقت.",
    descriptionEn: "12-minute delay in escort convoy arrival at Royal Terminal due to a temporary security detour.",
  ...
  },
  {
    ...
    complainantNameAr: "مساعد رئيس وفد سنغافورة (Dr. Chen Wei)",
    complainantNameEn: "Singapore Delegation Assistant (Dr. Chen Wei)",
    complainantRole: "VIP Guest Assistant",
    complainantRoleAr: "مساعد ضيف VIP",
    complainantRoleEn: "VIP Guest Assistant",
    severity: "NORMAL" as const,
    category: "HOTEL" as const,
    description: "طلب تغيير الجناح الفندقي في فندق فورسيزونز إلى إطلالة هادئة غير مطلة على أعمال تجهيز الساحة.",
    descriptionAr: "طلب تغيير الجناح الفندقي في فندق فورسيزونز إلى إطلالة هادئة غير مطلة على أعمال تجهيز الساحة.",
    descriptionEn: "Request to reassign Four Seasons suite to a quiet wing away from plaza staging activities.",
    ...
    resolutionNotesAr: "تم التنسيق مع إدارة الفندق ونقل الضيف إلى جناح تنفيذي في الطابق 24.",
    resolutionNotesEn: "Coordinated with hotel management and upgraded guest to 24th floor Executive Suite."
  },
  {
    id: "cmp-003",
    activityName: "Heritage Diriyah VIP Gala",
    complainantName: "مشرف البروتوكول بالفعالية (فريق صلة الميداني)",
    complainantNameAr: "مشرف البروتوكول بالفعالية (فريق صلة الميداني)",
    complainantNameEn: "Event Protocol Officer (Sila Field Ops)",
    complainantRole: "Field Coordinator",
    complainantRoleAr: "منسق ميداني",
    complainantRoleEn: "Field Coordinator",
    severity: "CRITICAL" as const,
    category: "SCHEDULE" as const,
    description: "تداخل وصول وفدين رئيسيين في بوابة وادي حنيفة بالتزامن مع إغلاق مسار الحافلات الترددية.",
    descriptionAr: "تداخل وصول وفدين رئيسيين في بوابة وادي حنيفة بالتزامن مع إغلاق مسار الحافلات الترددية.",
    descriptionEn: "Simultaneous arrival of two principal delegations at Wadi Hanifah Gate during shuttle corridor hold.",
...
export const DEFAULT_TEAM_MEMBERS = [
  {
    ...
    roleTitleAr: "قائد عمليات النقل الميداني",
    roleTitleEn: "Ground Transport Lead",
    phone: "+966551234001",
  ...
  },
  {
    ...
    roleTitleAr: "مشرفة بروتوكول كبار الشخصيات",
    roleTitleEn: "VIP Protocol Officer",
    phone: "+966551234002",
  ...
  },
  {
    ...
    roleTitleAr: "منسق حركة صالات المطار",
    roleTitleEn: "Airport Terminal Dispatcher",
    phone: "+966551234003",
  ...
  },
  {
    ...
    roleTitleAr: "مشرف التسكين وضيافة الفنادق",
    roleTitleEn: "Hotel Liaison Lead",
    phone: "+966551234004",
...
export const DEFAULT_SCHEDULE_AMENDMENTS = [
  {
    ...
    titleEn: "Flight Delay: UAE Special Envoy Private Jet",
    type: "FLIGHT_DELAY" as const,
    originalTime: "14:30",
    revisedTime: "15:45",
    affectedGuests: "معالي رئيس الوفد والوفد المرافق (8 ضيوف VIP)",
    affectedGuestsAr: "معالي رئيس الوفد والوفد المرافق (8 ضيوف VIP)",
    affectedGuestsEn: "Delegation Head & 8 Accompanying VIP Guests",
  ...
  },
  {
    ...
    titleEn: "Schedule Shift: Closed Ministerial Roundtable",
    type: "VIP_AGENDA_SHIFT" as const,
    originalTime: "18:00",
    revisedTime: "17:15",
    affectedGuests: "كافة وزراء وممثلي الصناديق السيادية (18 ضيفاً)",
    affectedGuestsAr: "كافة وزراء وممثلي الصناديق السيادية (18 ضيفاً)",
    affectedGuestsEn: "All Ministers & Sovereign Wealth Delegates (18 VIPs)",
  ...
  },
  {
    ...
    titleEn: "Convoy Reroute: Royal Dinner Convoy via King Salman Road",
    type: "CONVOY_REROUTE" as const,
    originalTime: "20:00",
    revisedTime: "20:10",
    affectedGuests: "الموكب الملكي (12 مركبة كاديلك ومايباخ)",
    affectedGuestsAr: "الموكب الملكي (12 مركبة كاديلك ومايباخ)",
    affectedGuestsEn: "Royal Convoy (12 Cadillac & Maybach Vehicles)",
    status: "CONFIRMED" as const,
    updatedAt: "منذ ساعة"
  }
];
...
export const DEFAULT_CLIENT_MESSAGES = [
  {
    ...
    senderNameAr: "الأستاذ / عبد الرحمن المهيدب (العميل)",
    senderNameEn: "Mr. Abdulrahman Al Muhaidib (Client)",
    senderRole: "CLIENT" as const,
    message: "نرجو التأكيد على جاهزية موكب الاستقبال الإضافي لوزير التجارة فور هبوط طائرته في الصالة الملكية الساعة 15:45.",
    messageAr: "نرجو التأكيد على جاهزية موكب الاستقبال الإضافي لوزير التجارة فور هبوط طائرته في الصالة الملكية الساعة 15:45.",
    messageEn: "Please confirm readiness of the auxiliary escort convoy for the Minister of Commerce upon landing at 15:45.",
    timestamp: "10:14 AM",
    isRead: true
  },
  {
    ...
    senderNameAr: "مدير العمليات اللوجستية (صلة)",
    senderNameEn: "Logistics Operations Manager (Sila)",
    ...
    messageAr: "تم توجيه الكابتن فهد القحطاني وسيارتي مايباخ مرافقة للوقوف في الرصيف الداخلي للصالة الملكية، وجاهزون بنسبة 100%.",
    messageEn: "Captain Fahad Al Qahtani and two Maybach vehicles have been dispatched to Royal Terminal inner curbside. 100% ready.",
    timestamp: "10:18 AM",
    isRead: true
  }
];
